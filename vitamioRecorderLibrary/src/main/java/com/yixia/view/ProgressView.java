...
public class ProgressView extends View {
	...
	public OnProChangLiner proChangLiner;
	...
	private void init() {
		...
		mActivePaint.setColor(getResources().getColor(R.color.color_white));
...
//				R.color.camera_progress_overflow));
	...
	/** 录制超市 */
	private final static int HANDLER_INVALIDATE_END= 2;
		...
		public void dispatchMessage(Message msg) {
			switch (msg.what) {
				...
				case HANDLER_INVALIDATE_RECORDING:
					...
					break;
				case HANDLER_INVALIDATE_END:
					proChangLiner.progress(mMediaObject.getDuration());
					break;
			}
	...
	protected void onDraw(Canvas canvas) {
		...
		if (mMediaObject != null && mMediaObject.getMedaParts() != null) {
			...
			if (hasOutDuration) {
				maxDuration = currentDuration;
				proChangLiner.progress(maxDuration);
			}
	...
	public interface   OnProChangLiner{
		void progress(int progress);
	}
	public void setProChangLiner(OnProChangLiner proChangLiner) {
		this.proChangLiner = proChangLiner;
	}
}
