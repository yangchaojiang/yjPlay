...
public class MediaRecorderNative extends MediaRecorderBase implements MediaRecorder.OnErrorListener {
	...
	protected void onStartPreviewSuccess() {
		...
		UtilityAdapter.RenderOutputSettings(480, 480, mFrameRate, UtilityAdapter.OUTPUTFORMAT_YUV | UtilityAdapter.OUTPUTFORMAT_MASK_MP4 /*
																																		 * |
																																		 * UtilityAdapter
																																		 * .
																																		 * OUTPUTFORMAT_MASK_HARDWARE_ACC
																																		 */);
	}
