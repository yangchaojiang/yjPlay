...
[![Download](https://api.bintray.com/packages/ycjiang/ycjiang/VideoPlayModule/images/download.svg?version=1.9.7) ](https://bintray.com/ycjiang/ycjiang/VideoPlayModule/1.9.7/link)
 ...
 ### 一.引用类库
  ...
  dependencies {
     //完整版
     compile 'com.ycjiang:VideoPlayModule:1.9.6'
     //精简版（没有smoothstreaming,dash,hls,只有常规点播功能）
     compile 'com.ycjiang:VideoPlayModule-Lite:1.9.6'
