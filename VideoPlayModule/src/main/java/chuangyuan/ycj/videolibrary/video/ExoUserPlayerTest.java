...
import chuangyuan.ycj.videolibrary.widget.BelowView;
 ...
 class ExoUserPlayerTest implements ExoPlayer.EventListener, View.OnClickListener, SimpleExoPlayer.VideoListener,PlaybackControlView.VisibilityListener {

    private static final String TAG = ExoUserPlayerTest.class.getName();
     ...
     * @param uri      地址
     **/
    public ExoUserPlayerTest(@NonNull Activity activity, @NonNull String uri) {
     ...
     **/
    public ExoUserPlayerTest(@NonNull Activity activity, SimpleExoPlayerView playerView) {
        this.playerView = playerView;
        this.activity = activity;
        initView();
    }

    public ExoUserPlayerTest(@NonNull Activity activity) {
        this.activity = activity;
        initView();
    }
    ...
    private void initView() {
        ...
        playerView.findViewById(R.id.exo_play_btn_hint).setOnClickListener(this);
